...
public class SideMenuActivity extends BaseAppCompatActivity {

    @BindView(R.id.base_drawer_layout)
    DrawerLayout mBaseDrawerLayout;
    @BindView(R.id.left_drawer)
    PercentFrameLayout mSideMenuDrawer;
    @BindView(R.id.notes_screen_ttext_view)
    TextTextView mNotesScreenTtextView;
    ...
    private void initListeners() {
        ...
        Stream.of(mNotesScreenTtextView)
